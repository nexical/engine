...
import { CommandRegistry } from '../../../src/services/CommandRegistry.js';
import { Command } from '../../../src/models/Command.js';

describe('CommandRegistry', () => {
    let registry: CommandRegistry;
    let mockPlugin: Command;
    let tempDir: string;
    ...
    it('should warn on duplicate registration', () => {
        ...
        registry.register(mockPlugin);
        registry.register(mockPlugin);
        expect(consoleSpy).toHaveBeenCalledWith("Command 'test-command' is already registered. Overwriting.");
    ...
    describe('load', () => {
        ...
        it('should handle import errors', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Failed to load command from'), expect.any(Error));
            consoleSpy.mockRestore();
        });
