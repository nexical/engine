...
describe('FileSystemService', () => {
    ...
    describe('appendFile', () => {
        ...
        it('should throw error on append failure', () => {
            mockFs.appendFileSync.mockImplementation(() => { throw new Error('fail'); });
    ...
    describe('move/copy', () => {
        ...
        it('should throw on move failure', () => {
            mockFs.moveSync.mockImplementation(() => { throw new Error('fail'); });
        ...
        it('should throw on copy failure', () => {
            mockFs.copySync.mockImplementation(() => { throw new Error('fail'); });
    ...
    describe('ensureDir/exists/isDirectory', () => {
        ...
        it('should throw SystemError on ensureDir failure', () => {
            mockFs.ensureDirSync.mockImplementation(() => { throw new Error('fail'); });
        ...
        it('should return false if stat fails', () => {
            mockFs.statSync.mockImplementation(() => { throw new Error('noent'); });
    ...
    describe('writeFileAtomic', () => {
        ...
        it('should cleanup temp file on error', () => {
            mockFs.renameSync.mockImplementation(() => { throw new Error('fail'); });
    ...
    describe('deleteFile', () => {
        ...
        it('should throw on delete failure', () => {
            mockFs.existsSync.mockReturnValue(true);
            mockFs.unlinkSync.mockImplementation(() => { throw new Error('fail'); });
    ...
    describe('locking', () => {
        ...
        it('should retry acquiring lock', async () => {
            (mockFs.openSync as jest.Mock)
                .mockImplementationOnce(() => { throw new Error('exists'); })
                .mockReturnValue(123);
        ...
        it('should throw after max retries', async () => {
            (mockFs.openSync as jest.Mock).mockImplementation(() => { throw new Error('exists'); });
