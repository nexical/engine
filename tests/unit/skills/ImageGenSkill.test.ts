...
import type { ImageGenSkill as ImageGenSkillType } from '../../../src/skills/ImageGenSkill.js';
...
const { ImageGenSkill } = await import('../../../src/skills/ImageGenSkill.js');

describe('ImageGenSkill', () => {
    let imageGenSkill: ImageGenSkillType;
    ...
    beforeEach(() => {
        ...
        imageGenSkill = new ImageGenSkill(mockOrchestrator);
    ...
    it('should always be supported', () => {
        expect(imageGenSkill.isSupported({ binaries: {} } as any)).toBe(true);
    });
    ...
    it('should generate and save an image successfully (Base64 response)', async () => {
        ...
        const result = await imageGenSkill.execute(agent, 'Draw a cat', {
    ...
    it('should handle Data URI response', async () => {
        ...
        await imageGenSkill.execute(agent, 'Draw a cat', {
            params: { output_path: 'cat.png' }
        });
    ...
    it('should throw if API key is missing', async () => {
        ...
        await expect(imageGenSkill.execute(agent, 'Draw a cat')).rejects.toThrow('Missing API Key');
    });
    ...
    it('should throw if generation fails', async () => {
        ...
        await expect(imageGenSkill.execute(agent, 'Draw a cat')).rejects.toThrow('Generation failed');
    });
    ...
    it('should throw if no image data returned', async () => {
        ...
        await expect(imageGenSkill.execute(agent, 'Draw a cat')).rejects.toThrow('No image data returned');
    });
