...
export class Skill {
    ...
    private async runDriver(phase: 'analysis' | 'execution' | 'verification', context: ISkillContext): Promise<Result<string, Error>> {
    ...
    private async runCommands(commands: string[], runner: (cmd: string, args?: string[]) => Promise<string>): Promise<void> {
